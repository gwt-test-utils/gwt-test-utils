...
/**
 * Defines an error reporter for reporting HTML errors. There is no such thing as a fatal error in
 * parsing HTML. I/O errors are fatal but should throw an <code>IOException</code> directly instead
