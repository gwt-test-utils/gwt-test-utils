...
/**
 * This interface extends the XNI <code>XMLComponent</code> interface to add methods that allow the
 * preferred default values for features and properties to be queried.
 *
 * @author Andy Clark
