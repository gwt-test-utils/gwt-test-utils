 ...
 * early versions of XNI, the augmentations interface contained a <code>clear()</code> method to
 * remove all of the items from the augmentations instance. A later version of XNI changed this
 * method to <code>removeAllItems()</code>. Therefore, this class extends the augmentations
 * interface and explicitly implements both of these methods.
 * <p>
