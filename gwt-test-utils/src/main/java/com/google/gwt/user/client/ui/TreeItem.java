...
public class TreeItem extends UIObject implements IsTreeItem, HasTreeItems,
  ...
  public static class TreeItemImpl {
    public TreeItemImpl() {
      System.out.println("TreeItemImpl generated - init elements now");
    ...
    void initializeClonableElements() {
      if (GWT.isClient()) {
        System.out.println("Elements will be created");
  ...
  TreeItem(boolean isRoot) {
    this.isRoot = isRoot;
    System.out.println("BASE_BARE_ELEM: " + BASE_BARE_ELEM);
