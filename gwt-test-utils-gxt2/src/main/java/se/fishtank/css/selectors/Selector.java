 ...
 * 
 * @see <a href="http://www.w3.org/TR/css3-selectors/#selector-syntax">Selector syntax
 *      description</a>
 * 
...
class Selector {
   ...
   /**
    * Create a new instance with the tag name set to the value of {@link #UNIVERSAL_TAG}, and with
    * the combinator set to {@link Combinator#DESCENDANT}. The list of {@linkplain #specifiers
